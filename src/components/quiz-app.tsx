...
export default function QuizApp() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-slate-300 text-foreground dark:bg-slate-900 relative z-10">
      {state.showResults ? (
        ...
        <div className="bg-card p-8 rounded-lg shadow-md w-full max-w-md dark:shadow-white">
